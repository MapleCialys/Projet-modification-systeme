...
I29 | Filtre retard | Filtre pour afficher uniquement les films en retard | 1 | N/A | 1 |
I30 | Ajout film | Formulaire pour ajouter des films dans la base de données | 2 | N/A | 1 |
I31 | Valider ajout film | Bouton soumettre le formulaire pour ajouter des films dans la base de données | 2 | N/A | 1 |
I32 | Ajout acteur | Formulaire pour ajouter des acteurs dans la base de données | 2 | N/A | 1 |
I33 | Valider acteur | Bouton soumettre le formulaire pour ajouter des acteur dans la base de données | 2 | N/A | 1 |
I34 | Modifier film | Formulaire pour modifier des films de la base de données | 2 | N/A | 1 |
I35 | Valider modification film | Bouton soumettre le formulaire pour modifier des films de la base de données | 2 | N/A | 1 |
I36 | Modifier acteur | Formulaire pour modifier des acteurs de la base de données | 2 | N/A | 1 |
I37 | Valider modifier acteur | Bouton soumettre le formulaire pour modifier des acteur de la base de données | 2 | N/A | 1 |
I38 | Suppression film | Formulaire pour supprimer des films de la base de données | 2 | N/A | 1 |
...
I46 | Notification courriel | Notifier l'utilisateur quand il valide une reservation | 0 | N/A | 1 |
I47 | Gestion | Gestion des comptes total | 3 | N/A | 3 |